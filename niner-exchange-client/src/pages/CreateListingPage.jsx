                    ...
                    >
                        ...
                        <div className="flex flex-wrap *:w-1/2 sm:*:w-1/4 *:items-center *:flex-col *:flex *:rouded-md *:border *:p-1 *:text-black">
                            <button
                                ...
                                className={`rounded-l-md hover:bg-emerald-600 ${formData.listing_type === 'TEXTBOOK' ? 'bg-emerald-600' : 'bg-white'}`}
                            >
                                <BookOpen />
                                <p>Textbook</p>
                            </button>
                            <button
                                ...
                                className={`hover:bg-emerald-600 ${formData.listing_type === 'SUBLEASE' ? 'bg-emerald-600' : 'bg-white'}`}
                            >
                                <Home />
                                <p>Sublease</p>
                            </button>
                            <button
                                ...
                                className={`hover:bg-emerald-600 ${formData.listing_type === 'ITEM' ? 'bg-emerald-600' : 'bg-white'}`}
                            >
                                <Package />
                                <p>Item</p>
                            </button>
                            <button
                                ...
                                className={`rounded-r-md hover:bg-emerald-600 ${formData.listing_type === 'SERVICE' ? 'bg-emerald-600' : 'bg-white'}`}
                            >
                                <Briefcase />
                                <p>Service</p>
                            </button>
                        ...
                        <div>
                            <label
                                htmlFor="images"
                                className="inline-block my-3 px-4 py-2 bg-emerald-600 text-white rounded hover:bg-emerald-700"
                            >
                                Upload Images
                            </label>
                            <input
