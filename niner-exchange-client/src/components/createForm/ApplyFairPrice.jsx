...
export default function ApplyFairPrice({
    formData,
    imageFiles,
    onChange,
    onBackClick,
    ...
    return (
        <div className="shadow rounded-lg max-w-lg w-full p-6 bg-zinc-300">
            <button
                type="button"
                onClick={() => onBackClick('form')}
                className="shadow rounded-md p-1 bg-zinc-400"
            >
                <ChevronLeft />
            </button>
            ...
            <div className="flex flex-col items-end">
                <p>Suggested price: </p>
                <small>
                    <em>according to data from eBay</em>
                </small>
                {suggested_price != null ? (
                    <div>
                        <p>Market Price (NEW): </p>
                        <p className="text-green-500 text-3xl font-bold underline">
                            ${Object.values(suggested_price)[0]}
                        </p>
                        {formData.condition != 'NEW' && (
                            <>
                                <p>Market Price ({formData.condition}) </p>
                                <p className="text-orange-500 text-3xl font-bold underline">
                                    ${Object.values(suggested_price)[1]}
                                </p>
                            </>
                        )}
                    </div>
